...
) = t2c.convert_topagnps_output_to_cche1d_input(
    filepath_agflow,
...
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_nodes
)
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_channel
)
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_link
)
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_reach
)
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_csec
)
t2c.write_cche1d_dat_file(
    f"{outputfolder}{casename}_min_strahler_{min_strahler}", df_csprf
)
