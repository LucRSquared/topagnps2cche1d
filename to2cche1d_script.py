...
df_nodes, df_channel, df_link, df_reach, df_csec, df_csprf, img_reach = t2c.convert_topagnps_output_to_cche1d_input(filepath_agflow, filepath_flovec, filepath_annagnps_reach_ids)
...
t2c.write_cche1d_dat_file(outputfolder+casename, df_reach)
t2c.write_cche1d_dat_file(outputfolder+casename, df_csec)
t2c.write_cche1d_dat_file(outputfolder+casename, df_csprf)
